...
and Velero, we can configure a production-ready QuestDB on Kubernetes. I look
forward to enhancing this setup in future releases when QuestDB adds more
monitoring and ops features.

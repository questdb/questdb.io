...
Prior to the InfluxDB 2.x release in 2019, the InfluxDB Platform consisted of
the TICK stack: Telegraf (agent for collecting and reporting metrics), InfluxDB,
...
- **Hypertables:** TimescaleDB
  ...
  location identifier, or a stock symbol. These chunks can be configured to hold
  the most recent data in memory, asynchronously compress and re-order data by
  the time column to disk (instead of ingestion time), and replicate or migrate
  transactionally across nodes.

...
description:
  Use a Jupyter notebook to insert and query data and graph query results using
  Python.
---
...
table has a designated new record, timestamps must be great than or equal to the

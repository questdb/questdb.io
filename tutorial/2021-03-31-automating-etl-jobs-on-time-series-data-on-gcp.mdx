...
[QuestDB Web Console](https://questdb.io/docs/reference/web-console/) and start
writing queries.

<Screenshot
  alt="The QuestDB Web Console accessible on a Google Cloud Platform VM Instance"
  height={181}
  src="/img/tutorial/2021-03-31/web-console.png"
  width={650}
/>
...
[QuestDB documentation for timestamp](https://questdb.io/docs/concept/designated-timestamp/).
...
<Screenshot
  alt="Editing a Cloud Function on Google Cloud Platform"
  height={296}
  src="/img/tutorial/2021-03-31/editing-cloud-functions.png"
  width={650}
/>

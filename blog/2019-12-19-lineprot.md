...
[comparing InfluxDB, TimescaleDB and QuestDB](/tutorial/2021/07/05/comparing-questdb-timescaledb-influxdb)
...
<Screenshot
  alt="Bar chart showing the CPU usage of InfluxDB, idle vs on load"
  height={591}
  src="/img/blog/2019-12-19/impliedSpeed.png"
  width={770}

      ...
      <section className={seCss.section}>
        ...
        >
          ...
          <p className="font-size--large">
            ...
            the best performance. That said, as the company was growing, performance
            started to degrade and it became expensive to run. After a short
            time, they had a small cluster of 4 x m4.2xlarge machines, and memory
          ...
          <p className="font-size--large">
            When evaluating a new solution, Toggle knew that they had to answer the
            following questions:
          </p>
          ...
          <p className="font-size--large">
            ...
            side & ingest in the other. Toggle imported over 600 million data points
            in a few minutes.
          </p>
          <h3>
          ...
          <p className="font-size--large">
            Armenak, Toggle's CTO: The QuestDB team assisted us in all steps along the way. 
            They were proactive in supporting our changeover, helping to debug issues as
